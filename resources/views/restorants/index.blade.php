@extends('layouts.app', ['title' => __('Vendors')])
@section('admin_title')
    {{__('Vendor')}}
@endsection
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">{{ __('Vendors') }}</h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="{{ route('admin.restaurants.create') }}" class="btn btn-sm btn-primary">{{ __('Add Vendor') }}</a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        ...
                                                        <form action="{{ route('admin.restaurants.destroy', $restorant) }}" method="post">
                                                            ...
                                                            @else
                                                            <button type="button" class="dropdown-item" onclick="confirm('{{ __("Are you sure you want to deactivate this retailler?") }}') ? this.parentElement.submit() : ''">
                                                                {{ __('Deactivate') }}
                                                            </button>
                                                            @endif
                                                    ...
                                                    <a class="dropdown-item warning red" onclick="return confirm('Are you sure you want to delete this Vendor from Database? This will aslo delete all data related to it. This is irreversible step.')"  href="{{ route('admin.restaurant.remove',$restorant)}}">{{ __('Delete') }}</a>
