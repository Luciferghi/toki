                    ...
                    <div class="card card-stats mb-4 mb-xl-0">
                        <div class="card-body">
                            <?php if(auth()->user()->hasRole('admin')): ?>
                                <div class="row">
                                    <div class="col">
                                        <h5 class="card-title text-uppercase text-muted mb-0"><?php echo e(__('Number of vendors')); ?></h5>
                                        <span class="h2 font-weight-bold mb-0"><?php echo e($countItems); ?> <?php echo e(__('vendors')); ?></span>
                                    </div>
                                    <div class="col-auto">
...
<?php /**PATH C:\xampp8\htdocs\toki_main\resources\views/layouts/headers/cards.blade.php ENDPATH**/ ?>