                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Vendors')); ?></h3>
                            </div>
                            <div class="col-4 text-right">
                                <a href="<?php echo e(route('admin.restaurants.create')); ?>" class="btn btn-sm btn-primary"><?php echo e(__('Add Vendor')); ?></a>
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow">
                                                        ...
                                                        <form action="<?php echo e(route('admin.restaurants.destroy', $restorant)); ?>" method="post">
                                                            ...
                                                            <?php else: ?>
                                                            <button type="button" class="dropdown-item" onclick="confirm('<?php echo e(__("Are you sure you want to deactivate this retailler?")); ?>') ? this.parentElement.submit() : ''">
                                                    ...
                                                    <a class="dropdown-item warning red" onclick="return confirm('Are you sure you want to delete this Vendor from Database? This will aslo delete all data related to it. This is irreversible step.')"  href="<?php echo e(route('admin.restaurant.remove',$restorant)); ?>"><?php echo e(__('Delete')); ?></a>
...
<?php echo $__env->make('layouts.app', ['title' => __('Vendors')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rukesh\Downloads\toki-main\toki-main\resources\views/restorants/index.blade.php ENDPATH**/ ?>
