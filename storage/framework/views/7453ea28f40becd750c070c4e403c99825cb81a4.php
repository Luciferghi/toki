<ul class="navbar-nav">
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('admin.restaurants.edit',  auth()->user()->restorant->id)); ?>">
            <i class="ni ni-shop text-info"></i> <?php echo e(__('Vendors')); ?>

        </a>
    </li>
    <li class="nav-item">
        <a class="nav-link" href="<?php echo e(route('items.index')); ?>">
            <i class="ni ni-collection text-pink"></i> <?php echo e(__('Products')); ?>
...
<?php /**PATH C:\Users\Rukesh\Downloads\toki-main\toki-main\resources\views/layouts/navbars/menus/owner.blade.php ENDPATH**/ ?>
