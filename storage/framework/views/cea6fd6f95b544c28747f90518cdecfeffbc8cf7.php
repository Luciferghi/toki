<?php $__env->startSection('content'); ?>
    <?php echo $__env->make('restorants.partials.header', ['title' => __('Add Vendor')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="card bg-secondary shadow">
                    <div class="card-header bg-white border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0"><?php echo e(__('Vendor Management')); ?></h3>
                            </div>
                    ...
                    <div class="card-body">
                        <h6 class="heading-small text-muted mb-4"><?php echo e(__('Vendor information')); ?></h6>
                        <div class="pl-lg-4">
                            <form method="post" action="<?php echo e(route('admin.restaurants.store')); ?>" autocomplete="off">
                                <?php echo csrf_field(); ?>
                                <div class="form-group<?php echo e($errors->has('name') ? ' has-danger' : ''); ?>">
                                    <label class="form-control-label" for="name"><?php echo e(__('Vendor Name')); ?></label>
...
<?php echo $__env->make('layouts.app', ['title' => __('Restaurant Management')], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Rukesh\Downloads\toki-main\toki-main\resources\views/restorants/create.blade.php ENDPATH**/ ?>
